...
let data_p_calc = new Date('11/16/2022 14:20:00').getTime();
let data_p_fsc = new Date('11/14/2022 16:10:00').getTime();
let data_p_termo = new Date('11/10/2022 16:10:00').getTime();
