...
let data_p_calc = new Date('11/23/2022 00:00:00').getTime();
let data_p_fsc = new Date('11/16/2022 00:00:00').getTime();
let data_p_termo = new Date('11/10/2022 00:00:00').getTime();
